...
var xmlhttp;
            ...
            var str=[];
                        for (var i = 0; i < obj.length; i ++ ) {//
                                ...
                                { 
                                 if(j===2){
                                     str += obj[i].data[j]; 
                                  //   console.log("i: "+i+"J: "+j+" "+str);
                                 }
                              if(i==obj.length-1&&j==obj.length-1){
                                   console.log(str);
                               }
                               // -*
        
                  //  console.log(str.filter(str => str.length));
    ...
    //
    var url="https://script.google.com/macros/s/AKfycby3-2h1EK72LIrCBdq5GaqB774u8bJytlVPYoSIQg8NIfhkzAcNn5DRCA/exec"; //即時行止表
